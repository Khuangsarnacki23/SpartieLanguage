...
public class SpartieParser {
    ...
    private Statement forStatement() {
        ...
        Statement incrementStatement = new Statement.ExpressionStatement(increment);
        List<Statement> bodyAndIncrement = new ArrayList<>();
        bodyAndIncrement.add(body);
        bodyAndIncrement.add(incrementStatement);

        body = new Statement.BlockStatement(bodyAndIncrement);

        body = new Statement.WhileStatement(condition, body);

        List<Statement> initializerAndLoop = new ArrayList<>();
        initializerAndLoop.add(initializer);
        initializerAndLoop.add(body);

        return body = new Statement.BlockStatement(initializerAndLoop);
